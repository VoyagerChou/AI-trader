"""
OpenAPI / flask-smorest integration for the AI-Trader human web API.
...
def init_openapi(app: Flask) -> Api:
    ...
    app.config.setdefault("API_TITLE", "AI-Trader Web API")
    app.config.setdefault("API_VERSION", "1.0.0")
    app.config.setdefault("OPENAPI_VERSION", "3.0.3")
    app.config.setdefault(
        "OPENAPI_DESCRIPTION",
        (
            "Human-facing REST API for AI-Trader. "
    ...
    app.config.setdefault(
        "API_SPEC_OPTIONS",
        {
            "info": {
                ...
                "contact": {
                    "name": "AI-Trader",
                    "url": "https://github.com/brokermr810/ai-trader",
                },
                "license": {
    ...
    app.extensions["ai-trader_openapi_api"] = api
    return api


def get_openapi_api(app: Flask) -> Api | None:
    return app.extensions.get("ai-trader_openapi_api")
