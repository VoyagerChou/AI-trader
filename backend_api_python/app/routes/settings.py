    ...
    'brand': {
        ...
        'items': [
            ...
            },
            {
                ...
                'type': 'text',
                'default': '© 2025-2026 AI-Trader. All rights reserved.',
    ...
    'contact': {
        ...
        'items': [
            ...
            },
            {
                ...
                'type': 'text',
                'default': 'https://github.com/brokermr810/AI-Trader/issues',
        ...
        'items': [
            {
                ...
                'label': 'Secret Key',
                'type': 'password',
                'default': 'ai-trader-secret-key-change-me',
        ...
        'items': [
            {
                ...
                'default': 'tavily',
                'description': 'Primary news/web search provider used by AI analysis. AI-Trader falls back to configured providers, then GDELT and DuckDuckGo when available'
            },
            {
    ...
    'security': {
        ...
        'items': [
            ...
            },
            {
                ...
                'type': 'text',
                'required': False,
                'description': 'Comma-separated scheme+host (+ optional port) of additional frontends allowed as OAuth post-login redirect targets, e.g. https://m.ai-trader.com,https://app.ai-trader.com. FRONTEND_URL is always allowed implicitly.'
            },
            {
...
_BRAND_DEFAULTS = {
    'app_name': 'AI-Trader',
    'copyright': '© 2025-2026 AI-Trader. All rights reserved.',
    'contact_email': 'support@ai-trader.com',
    'contact_support_url': 'https://t.me/ai-trader',
    'contact_feature_request_url': 'https://github.com/brokermr810/AI-Trader/issues',
    'contact_live_chat_url': 'https://t.me/ai-trader',
    'social_github': 'https://github.com/brokermr810/AI-Trader',
    'social_x': 'https://x.com/ai-trader_en',
    'social_discord': 'https://discord.com/invite/tyx5B6TChr',
    'social_telegram': 'https://t.me/ai-trader',
    'social_youtube': 'https://youtube.com/@ai-trader',
}
...
def get_brand_config():
    ...
    Empty ENV values fall back to the bundled AI-Trader defaults so a fresh
            ...
            if requested_admin_email and requested_admin_email != 'admin@example.com':
                ...
                if not admin_username:
                    try:
                        ...
                        admin_username = str(Config.ADMIN_USER or 'ai-trader')
                    except Exception:
                        admin_username = 'ai-trader'
