...
def ai_generate_strategy():
    ...
    try:
        ...
        if intent == 'bot_recommend':
            ...
            # USStock and Forex on AI-Trader are always spot; lock it so
...
"""
        ...
        def _repair_strategy_code_via_llm(bad_code: str, validation: dict) -> str:
            repair_prompt = (
                "You produced AI-Trader strategy script code that failed automatic validation. "
                ...
                "- Must compile and run in AI-Trader strategy runtime.\n"
