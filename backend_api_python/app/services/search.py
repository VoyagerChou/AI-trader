...
class ExaSearchProvider(BaseSearchProvider):
    ...
    def __init__(self, api_key: str):
        super().__init__([api_key] if api_key else [], "Exa")
        ...
        try:
            ...
            if response.status_code != 200:
                ...
                if response.status_code == 429:
                    error_msg = "Exa rate limit exceeded"
                elif response.status_code == 401:
                    error_msg = "Exa authentication failed - check EXA_API_KEY"
                return SearchResponse(
                    query=query,
                    results=[],
                    provider=self.name,
    ...
    def _do_search(self, query: str, api_key: str, max_results: int, days: int = 7) -> SearchResponse:
        ...
        try:
            ...
            headers = {
                ...
                "User-Agent": "AI-Trader/4.0 SearXNGSearchProvider",
            }
...
class SearchService:
    ...
    def _init_providers(self):
        ...
        exa_key = APIKeys.EXA_API_KEY
        if exa_key:
            provider_map["exa"] = ExaSearchProvider(exa_key)
            logger.info("Exa search is configured")
        ...
        for key in ("tavily", "exa", "searxng", "gdelt", "serpapi", "alpha_vantage", "google", "bing", "duckduckgo"):
    ...
    def provider_status(self) -> List[Dict[str, Any]]:
        ...
        return [
            ...
            for name in ("Tavily", "Exa", "SearXNG", "GDELT", "SerpAPI", "AlphaVantage", "Google", "Bing", "DuckDuckGo")
        ]
...
def _search_provider_note(name: str, configured: bool, registered: bool) -> str:
    ...
    if name == "Exa" and not configured:
        return "Set EXA_API_KEY to enable Exa neural search."
